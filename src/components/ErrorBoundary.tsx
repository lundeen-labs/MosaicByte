    ...
    return (
      ...
      >
        ...
        <p className="max-w-[60ch] text-[var(--color-ink-2)]">
          A component on this page threw before the studio could mount. Refreshing usually clears it. If it does not, email {COPY.contact.email} — include the URL.
        </p>
        ...
        <Link
          href="/"
          className="font-mono text-[11px] uppercase tracking-[0.08em] text-[var(--color-rust-text)] hover:text-[var(--color-rust-text)]"
        >
          ← Back to home
        </Link>
      </div>
